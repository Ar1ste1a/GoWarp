...
func main() {
	...
	//warpClient.GetValidateMachineOwnage(575)
	//warpClient.GetListEndgames()
	//warpClient.GetEndgameProfile(302)
	//warpClient.ListRetiredMachines()
	warpClient.Start()
}
